...
I'm using a new theme, too. I've gone with the [[https://github.com/adityatelange/hugo-PaperMod][PaperMod theme]] as an alternative to the [[https://github.com/jpanther/congo][Congo theme]] I'd been using. I was already using PaperMod on my micro.blog, so it seemed like a natural fit. It certainly wasn't because I stole the idea from Mike Hall's blog[fn:3]. I like it so far.
