...
Just add something like `errdocs "/errdocs"` in httpd.conf. Add an err.html file in /var/www/errdocs with the generic error message or create one for each error code, e.g. 404.html.
