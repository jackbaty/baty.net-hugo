---
title: 'Blog management fatigue'
date: 2026-02-13 06:07:19 -0500
slug: blog-management-fatigue
tags: ["Blogging"]
summary: 
---
...
I've been having a blast testing [Kev Quirk's](https://kevquirk.com/) new blogging platform, [Pure Blog](https://pureblog.org). He's done a great job of nailing the basics. It's easy and fun to use. So fun, in fact, that I've been teetering on using it for this blog at baty.net. 
...
I was considering archiving the baty.net [again](https://archive.baty.net) and starting fresh. That feels like crazy talk, but I can't help thinking about it. Wouldn't it be nice not lugging all this legacy cruft around? Except, it would break a lot of links. It's not like my posts are linked to that often, but they _are_ linked to. Seems rude.

Another option is to use one of my other domains. Baty.blog is a good candidate. That's currently running on [Blot](https://blot.im) but I'd [archived that blog](https://blot.baty.net) before. There's always copingmechanism.com.
