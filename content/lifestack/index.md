...
- **Lenovo ThinkPad X1 Carbon (2015)** – I tinker with stuff on this. I hate the trackpad more than anything.
- **Intel NUC i5** - Dedicated box for running Roon Core
- **UGREEN NAS** - Runs things like Immich, Miniflux, Jellyfin, etc. File archives.
...
- **Olympus Stylus Epic** – Compact 35mm film camera. I love these little things. Both of mine have light leaks and are unreliable. I refuse to pay what the internet wants for a new one.
...
- **[Darktable](https://www.darktable.org/)** - Raw file editor. Open source. Weird, but powerful.
- **[Immich](https://immich.app/)** – My library of final edits
- ~~**Adobe Lightroom** – Raw file editor and library. Once a while I still use Capture One.~~ Make one for Linux and we'll talk.
...
- **[Negative Lab Pro 35mm/120 scanning kit](https://www.negative.supply/shop-all/the-curated-kit-2025-97cri)** - Overpriced, but well-made and complete. I don't use it much, because I prefer using the Epson.
